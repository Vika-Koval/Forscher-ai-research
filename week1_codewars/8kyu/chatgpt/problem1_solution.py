...
#Request 2:
# Great, now solve this in Python.
# Convert number to reversed array of digits
# Given a random non-negative number, you have to return the digits of this number within an array in reverse order.
...
#Response: 
def reverse_array_of_digits(number):
...
print(digitize(23582357))      # Output: [7, 5, 3, 2, 8, 5, 3, 2]
print(digitize(984764738))     # Output: [8, 3, 7, 4, 6, 7, 4, 8, 9]
print(digitize(45762893920))   # Output: [0, 2, 9, 3, 9, 8, 2, 6, 7, 5, 4]
print(digitize(548702838394))  # Output: [4, 9, 3, 8, 3, 8, 2, 0, 7, 8, 4, 5]
